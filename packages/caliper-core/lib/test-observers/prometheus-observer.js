...
const PrometheusClient = require('../prometheus/prometheus-query-client');
...
class PrometheusObserver extends TestObserverInterface {
    ...
    constructor(configPath) {
        ...
        this.queryClient = new PrometheusClient(queryUrl);
        Logger.info(`Configured monitor to query URL ${queryUrl} every ${interval} seconds`);
    }
...
module.exports = PrometheusObserver;
